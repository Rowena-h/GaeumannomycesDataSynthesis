...
singularity exec ~/programmes/raxml-ng/raxml-ng-1.1.0.img raxml-ng \
	--parse \
	--msa ${alignment_dir}/${lineage}_concat.fa \
	--model ${alignment_dir}/${lineage}_partition.txt \
	--prefix ${out_dir}/${lineage}_concat
...
singularity exec ~/programmes/raxml-ng/raxml-ng-1.1.0.img raxml-ng \
	--bsconverge \
	--bs-trees ${out_dir}/${lineage}_concat.raxml.bootstraps \
        --prefix ${out_dir}/${lineage}_concat_convergence_test \
        --seed 2
